    ...
    home : (req,res) => {
        ...
        page : (req,res) => {
            ...
            db.query('SELECT * FROM author', (error, authors) => {
                ...
                db.query(`SELECT * FROM author WHERE id = ${id}`
                ,(error2, author) => {
                    if ( error2 ) {
                        throw error2;
                    }
                ...
                res.app.render('home', context, (err,html)=>{ res.end(html)
                })
            })
        });
    },
    ...
    update : function(req, res) {
        ...
        db.query('SELECT * FROM author', function(error, authors) {
            ...
            function(error2, author) {
                ...
                var context = {
                    list:authors,
                    control: `<a href="/create">create</a>&nbsp;&nbsp;<a href="/update/${author[0].id}">update</a>&nbsp;&nbsp; <a href="/delete/${author[0].id}" onclick='if(confirm("정말로 삭제하시겠습니까?")==false){ return false }'>delete</a>`,
                    body :`
